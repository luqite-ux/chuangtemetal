...
export const metadata: Metadata = buildPageMetadata("Factory", "Explore ChuangTe Metal's 8,000 m² facility, two workshops, three production lines and real equipment photography.", "/factory");
